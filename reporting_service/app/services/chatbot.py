...
class BusinessChatbot:
    ...
    def _init_collections(self):
        ...
        try:
            self.qdrant.delete_collection("analysis_reports")
            self.qdrant.delete_collection("chat_history")
        except:
            pass  # Collections might not exist yet
        
        # Create collections with correct vector size
    ...
    async def _upsert_chat_history(self):
        ...
        await self.chat_history_store.aadd_texts(
            texts=[history],
    ...
    def _create_retriever(self):
        ...
        return EnsembleRetriever(
            ...
            weights=[0.7, 0.3]  # Prioritize analysis context
        )
